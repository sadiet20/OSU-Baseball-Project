/*
 * Code to interact with AS5600 rotary absolute encoder
 * Original code by: Curious Scientist
...
int highbyte; //raw angle 7:0 and 11:8 //srt change to unsigned int?
...
void setup()
{
  Serial.begin(115200);
  while(!Serial);
  Serial.println("Welcome to the rotory absolute encoder!");
  ...
  //delay(1000);
  //serialTimer = millis(); //start the timer
...
{    
    ...
    delay(5000); //wait a little - adjust it for "better resolution"
