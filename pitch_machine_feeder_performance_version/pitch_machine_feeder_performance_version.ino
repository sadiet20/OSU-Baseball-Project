...
//wait 60 seconds before starting pitching
#define STARTING_DELAY 60*1000
...
//number of times remote have been pressed
...
void remotePress(){
  ...
  if(millis() - remote_time > 500){
    //remote count stores only 0 or 1
    remote_count = (remote_count + 1) % 2;
